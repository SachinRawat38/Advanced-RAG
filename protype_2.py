...
# Always use combined knowledge base
filter_retriever_by_source(None)  # No filter - always use both sources
...
and your uploaded documents by answering your questions based on the combined knowledge base.
""")
...
with st.sidebar:
    ...
    information about the FATF 40 Recommendations and any uploaded documents. 
    It uses a combined knowledge base to search across all available information sources
...
if prompt := st.chat_input("Ask about FATF40 recommendations or your documents..."):
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Searching all available documents..."):
            ...
            if not reviews or len(reviews) == 0:
                response = "I'm sorry, but I couldn't find relevant information in the knowledge base to answer your question."
            else:
